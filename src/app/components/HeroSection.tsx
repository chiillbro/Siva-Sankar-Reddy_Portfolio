...
export default function HeroSection() {
  ...
  const textVariant = (delay: number) => ({
     hidden: { opacity: 0, y: 20 },
     visible: { opacity: 1, y: 0, transition: { delay: delay, type: 'spring', stiffness: 80 } }
  });
    ...
    >
      ...
      >
          ...
          <motion.h1
           ...
           >
            I'm <span className="text-primary">Siva Sankar Reddy</span>.<br/> I build <span className='whitespace-nowrap'>performant & scalable</span> web solutions.
          </motion.h1>
          ...
          >
            Driven by the challenge of solving complex problems, from optimizing system architecture to crafting seamless user experiences. Always learning, always building.
          ...
          {/* Interactive Element - Example: Typing Effect (requires a library like react-type-animation) */}
           ...
           <motion.div
            ...
            >
               <span className="text-muted-foreground">{'>'}</span> <span className='text-primary'>currentStack</span> = [ <br />
               <span className='pl-4'>"React", "Next.js", "TypeScript",</span><br/>
               <span className='pl-4'>"Node.js", "NestJS", "PostgreSQL",</span><br/>
               <span className='pl-4'>"Docker", "AWS", "Go", "Python"</span> <br/>
               ];<br/>
               <span className="text-muted-foreground">{'>'}</span> <span className='text-primary'>status</span> = "Actively seeking SDE 1/2 roles";<br/>
               <span className="text-muted-foreground animate-subtle-pulse">_</span> {/* Blinking cursor */}
           </motion.div>
